...
int main()
{ 
  cout << "This App is used to make a data table using the full name, last 4 digits of SSN, and pin." << endl; // cout an explanation of what this App should be used for. 
  ...
  cin >> selection;
    ...
    case 1:  // Add and indicate slot
      ...
      cin >> thekey;
      cout << "What is the full name?" ;
      cin >> thename;
       //  Here get two more pieces of info
       cout << "What is the last 4 digits of your SSN?";
       cin >> lastSSN;
       cout << "What is the 4 digits of your credit card pin?";
       cin >> pin;
      //  Create the element with all the info using the 2nd constructor
	theelement = el_t(thekey, thename, lastSSN, pin);
      s = HT.add(theelement);
